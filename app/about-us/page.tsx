        ...
        <>
            <div className="bg-[#11150f] tf-container">
                ...
                <div className="flex flex-col" style={{ marginBottom: "20px" }}>
                    ...
                    <p style={{ color: "white" }}>
                        The app has been embraced by freedom lovers worldwide, who recognise its potential to disrupt the status quo and empower individuals to take control of their financial destinies. The Technology blend of decentralisation, security, and accessibility makes it an attractive option for those seeking an alternative to the central banking system and traditional financial services.
                    </p>
                </div>
                <div className="flex flex-col" style={{ marginBottom: "20px" }}>
                    <h2 className="font-semibold text-white mb-1" style={{ fontSize: "15px" }}>
