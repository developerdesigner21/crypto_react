...
const StepItem: React.FC<StepItemProps> = ({ number, title, description }) => {
    return (
        <div className="tw-flex tw-items-start tw-gap-4 lg:tw-gap-6 tw-py-4 tw-transition-transform tw-duration-300 tw-ease-in-out tw-hover:tw-scale-[1.01]">
            ...
            <div className="tw-flex-shrink-0 tw-w-20 tw-h-20 sm:tw-w-24 sm:tw-h-24 tw-flex tw-items-center tw-justify-center
            ...
            <div className="tw-flex-1 tw-pt-2"> {/* tw-pt-2 for slight vertical alignment adjustment */}
                <h4 className="tw-text-white tw-text-2xl sm:tw-text-3xl tw-font-semibold tw-mb-2 tw-leading-tight">
                    {title}
                </h4>
...
const PortfolioSection: React.FC = () => {
    return (
        <section
            className="tw-relative tw-py-[100px] tw-px-[30px] tw-bg-coiner-super-dark-bg tw-font-sans tw-overflow-hidden"
        >
            ...
            <div className="tw-relative tw-z-10 tw-container tw-max-w-7xl tw-mx-auto tw-flex tw-flex-col tw-items-center">
                ...
                <div className="tw-text-center tw-mb-16 tw-px-4"> {/* tw-px-4 for padding on very small screens */}
