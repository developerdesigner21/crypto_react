...
const FeatureCard: React.FC<FeatureCardProps> = ({ iconSrc, iconBgColorClass, title, description, alt }) => {
    return (
        <a
            ...
            className="tw-group tw-flex tw-flex-col sm:tw-flex-row tw-items-start sm:tw-items-center tw-gap-4 tw-p-4 sm:tw-p-4 tw-rounded-[15px]
...
const HowItWorks: React.FC = () => {
    return (
        <section
            className="tw-py-[100px] tw-px-[30px] tw-min-h-screen tw-flex tw-items-center tw-justify-center
        ...
        >
            ...
            <div className="tw-container tw-max-w-[1280px] tw-mx-auto tw-flex tw-flex-col tw-items-center">
                ...
                <div className="tw-text-center tw-mb-16 tw-px-4"> {/* tw-px-4 ensures padding on very small screens */}
                ...
                <div className="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-8 lg:tw-gap-12 tw-w-full tw-items-center">
                    ...
                    <div className="tw-grid tw-grid-cols-2 tw-gap-2 lg:tw-gap-8">
                        <FeatureCard
